...
const RipeItemEditIconButton: React.FC<Props> = ({ fromValues, id }: Props) => {
  ...
  return (
    <>
      ...
      <Modal visible={isModalVisible} onCancel={onCloseHandler} centered mask footer={null}>
        <VlanItemForm title={`${t('edit')} VLAN`} onCloseHandler={onCloseHandler} method='put' fromValues={fromValues} id={id} isRipeFrom />
      </Modal>
    </>
  )
}

export default RipeItemEditIconButton

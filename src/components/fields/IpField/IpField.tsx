...
const IpField: React.FC<Props> = ({ field: { name, value, onBlur }, form: { touched, errors }, label }: Props) => {
  ...
  return (
    <label className={cx('field-container')}>
      ...
      <Input name={name} value={value} onChange={onChangeHandler} onBlur={onBlur} type='text' pattern='[0-9.]*' maxLength={15} />

...
const PatternField: React.FC<Props> = ({ field: { name, value, onBlur }, form: { touched, errors }, label, type = 'text', pattern, maxLength }: Props) => {
  ...
  return (
    <label className={cx('field-container')}>
      ...
      <Input name={name} value={value} onChange={onChangeHandler} onBlur={onBlur} type={type} pattern={pattern} maxLength={maxLength} />
